...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      // TODO: remove ! from font-semibold once we remove everything but text sizes from [tailwind base config](https://github.com/livekit/web/blob/main/packages/bytes-core/tailwind/tailwind-base-presets.ts#L15-L34)
      size: {
