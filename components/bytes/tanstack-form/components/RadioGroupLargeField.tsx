      ...
      <fieldset className="grid w-full grid-cols-2 gap-2">
        {props.options.map((option) => (
          <Label
            ...
            data-disabled={option.disabled || props.disabled || props.readOnly}
            key={option.value}
            className={cn(
              `border-separator1 text-fg2 data-[selected=true]:border-separatorAccent data-[selected=true]:bg-bgAccent1 data-[selected=true]:text-fgAccent1 group data-[disabled=true]:bg-bg3 data-[disabled=true]:text-fg4 flex w-full cursor-pointer items-center gap-3 rounded border px-3 py-1.5 leading-[18px] font-normal data-[disabled=true]:cursor-not-allowed data-[selected=true]:font-semibold`,
              props.readOnly
          ...
          >
            <Input
              ...
              disabled={option.disabled || props.disabled || props.readOnly || isSubmitting}
