...
interface PanelTabsTriggerProps extends React.ComponentPropsWithoutRef<
  ...
  ({ className, ...props }, ref) => {
    return (
      <TabsPrimitive.Trigger
        className={cn(
          'inline-flex h-8 items-center justify-start gap-2 py-2 ps-3 pe-4 font-medium',
          'text-fg3 text-xs',
...
interface PanelTabsContentProps extends React.ComponentPropsWithoutRef<
