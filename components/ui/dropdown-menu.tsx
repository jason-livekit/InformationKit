...
import { CheckIcon, ChevronRightIcon, CirclePlaceholderOnIcon } from '@/icons/react';
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      'focus:bg-bg3 data-[state=open]:bg-bg3 flex cursor-default items-center rounded px-2 py-1.5 text-xs outline-hidden select-none focus:outline-hidden',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'focus:bg-bg3 focus:text-fg1 relative flex cursor-default items-center rounded py-1.5 pr-2 pl-8 text-xs outline-hidden transition-colors select-none data-disabled:pointer-events-none data-disabled:opacity-50',
      className,
    )}
    checked={checked}
    {...props}
