...
import { ArrowLeftIcon, MapIcon } from '@/icons/react';
    ...
    <div className="mx-auto flex w-full max-w-xl flex-col gap-6 px-6 py-10">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-fg3 text-sm">
          A map is a zoomable markdown table on an infinite canvas. Type cells with{' '}
          <code className="font-mono">| like | this |</code>, get automatic coloring, and zoom in
          for more detail.
        </p>
      </div>

      <form action={createMapAction} className="flex flex-col gap-4">
        <div className="border-separator1 bg-bg1 flex items-center gap-3 rounded-lg border p-4">
          <span className="bg-bgAccent2 text-fgAccent1 flex h-9 w-9 items-center justify-center rounded-md">
            <MapIcon className="h-5 w-5" />
          </span>
          <span className="text-fg0 text-sm font-semibold">Journey map</span>
        </div>
