...
export default function PublicMapLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <div className="bg-bg0 text-fg0 flex h-svh flex-col">
      <header className="border-b-separator1 bg-bg1 sticky top-0 z-30 flex h-12 shrink-0 items-center justify-between border-b px-6">
